...
import 'package:sopefoodusuario/models/address_request.dart';
                ...
                children: [
                  GoogleMap(
                    ...
                    initialCameraPosition: CameraPosition(
                      target: _selectedLocation ??
                          const LatLng(
                              6.5016666666, -75.7433333), // Default location
                      zoom: 15.0,
                    ),
            ...
            BackGroundContainer(
              child: ListView(
                ...
                children: [
                  ...
                  _buildtextfield(
                    hintText: "Instrucciones de Domicilio",
                  ...
                  CustomButton(
                    onTap: () {
                      if (_searchController.text.isNotEmpty &&
                        ...
                        Get.snackbar("Error", "Por favor llene los campos",
