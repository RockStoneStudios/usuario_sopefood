...
class _DirectionsPageState extends State<DirectionsPage> {
  ...
  LatLng _center = const LatLng(6.5174974, -75.724627073);
  ...
  Widget build(BuildContext context) {
    ...
    double precioTotal = 350 + distanceTime.price;
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    const Divida(),
                    RowText(
                        first: "Distancia al Restaurante",
                        second:
                    ...
                    RowText(
                        first: "Precio desde la ubicación actual",
                        second: "\$ ${(precioTotal.toStringAsFixed(0))}"),
                    SizedBox(
                      height: 5.h,
                    ),
                    RowText(
                        first: "Tiempo estimado de entrega",
                        second: "${totalTime.toStringAsFixed(0)} mins"),
                    SizedBox(
                      height: 5.h,
                    ),
                    RowText(
                        first: "Horario de atencion",
