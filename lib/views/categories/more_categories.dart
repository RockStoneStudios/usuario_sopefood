...
import 'package:sopefoodusuario/hooks/fetchAllCategories.dart';
import 'package:sopefoodusuario/models/categories.dart';
import 'package:sopefoodusuario/views/categories/categories_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: ReusableText(
            text: "Categorias", style: appStyle(12, kGray, FontWeight.w600)),
      ),
      body: isLoading
