...
class UserLocationController extends GetxController {
  ...
  var _restaurantLocation = const LatLng(6.5174974, -75.724627073).obs;
  ...
  var _currentLocation = const LatLng(6.5174974, -75.724627073).obs;
  ...
  var _userAddress = const Placemark(
    name: "Sopetran",
    street: "Parque principal",
    isoCountryCode: "CO",
    country: "Colombia",
    postalCode: "110911",
    administrativeArea: "Bogota",
    subAdministrativeArea: "Medellin",
    locality: "Sopetran",
    subLocality: "Parque Principal",
    thoroughfare: "Parque Principal",
    subThoroughfare: "1",
  ).obs;
